...
export const screens: Screen[] = [
  ...
  { id: "scr-2", name: "Times Sq · South", location: "New York", resolution: "4K", online: true },
  { id: "scr-3", name: "Shibuya Crossing", location: "Tokyo", resolution: "8K", online: true },
  { id: "scr-4", name: "Piccadilly Lights", location: "London", resolution: "4K", online: false },
  { id: "scr-5", name: "Champs-Élysées 12", location: "Paris", resolution: "4K", online: true },
  { id: "scr-6", name: "Marina Bay Tower", location: "Singapore", resolution: "4K", online: true },
  { id: "scr-7", name: "Sunset Strip 401", location: "Los Angeles", resolution: "4K", online: true },
  { id: "scr-8", name: "Gangnam Mega", location: "Seoul", resolution: "8K", online: true },
];
...
export const initialBlocks: ScheduleBlock[] = [
  ...
  { id: "b2", screenId: "scr-1", startHour: 9, endHour: 12, title: "Nike Air Launch", type: "program", status: "reserved", client: "Nike", recurring: "daily", campaign: "Air Max Drop" },
  ...
  { id: "b4", screenId: "scr-1", startHour: 18, endHour: 22, title: "Prime Time Block", type: "program", status: "conflict", client: "Multiple", campaign: "Conflicts: 2" },

  { id: "b5", screenId: "scr-2", startHour: 0, endHour: 6, title: "Maintenance Window", type: "program", status: "blocked" },
  { id: "b6", screenId: "scr-2", startHour: 8, endHour: 11, title: "Apple Vision Pro", type: "program", status: "reserved", client: "Apple", campaign: "Vision Spring" },
  ...
  { id: "b8", screenId: "scr-2", startHour: 19, endHour: 23, title: "Netflix Premiere", type: "program", status: "reserved", client: "Netflix" },

  { id: "b9", screenId: "scr-3", startHour: 5, endHour: 10, title: "Sony PlayStation", type: "program", status: "reserved", client: "Sony" },
  ...
  { id: "b11", screenId: "scr-3", startHour: 18, endHour: 24, title: "Toyota EV", type: "program", status: "reserved", client: "Toyota" },

  { id: "b12", screenId: "scr-4", startHour: 0, endHour: 24, title: "Screen Offline", type: "program", status: "blocked" },

  { id: "b13", screenId: "scr-5", startHour: 7, endHour: 10, title: "L'Oréal Spring", type: "program", status: "reserved", client: "L'Oréal" },
  ...
  { id: "b15", screenId: "scr-6", startHour: 9, endHour: 13, title: "Singapore Air", type: "program", status: "reserved", client: "SIA" },
  ...
  { id: "b17", screenId: "scr-7", startHour: 6, endHour: 11, title: "Tesla Cybertruck", type: "program", status: "reserved", client: "Tesla" },
  ...
  { id: "b19", screenId: "scr-8", startHour: 8, endHour: 12, title: "Samsung Galaxy", type: "program", status: "reserved", client: "Samsung", recurring: "daily" },
  ...
  { id: "b21", screenId: "scr-8", startHour: 20, endHour: 24, title: "BTS World Tour", type: "program", status: "reserved", client: "HYBE" },
];
